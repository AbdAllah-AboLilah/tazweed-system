...
<<<<<<< HEAD
const SW_VERSION = '0.91.1';
=======
const SW_VERSION = '0.91.0';
...
self.addEventListener('fetch', (event) => {
  ...
  // ============================================================
  // ⚠️⚠️ ملف البرنامج المساعد **مايعديش من هنا خالص**
  // ============================================================
  // كل طلب من نفس الموقع تحت بيتحفظ في الكاش. وملف البرنامج ~٧ ميجا —
  // يعني أول ما حد يدوس تحميل، الكاش بتاعه يكبر ٧ ميجا ويفضل كده،
  // ويمكن يوصل لحد المساحة ويطيّر باقي الملفات المحفوظة معاه.
  //
  // بنسيبه للمتصفح يتصرف فيه لوحده: تحميل عادي، من غير ما نلمسه.
  if (url.origin === self.location.origin && url.pathname.indexOf('/helper/dist/') !== -1) return;
