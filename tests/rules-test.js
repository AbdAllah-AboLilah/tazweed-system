...
(async () => {
  ...
  // ⚠️⚠️ مدير الفرع — العطل اللي اتصلّح هنا:
  // presetHas كانت بتقول "مدير الفرع مفتوح في كل حاجة ما عدا أربعة"،
  // والمفتاح ده مكانش فيهم — فالسحابة كانت بتسيبه يقرا، والشاشة
  // (ROLE_PRESETS) بتقول مقفول. وخيار "زي الرتبة" في شاشة الحسابات
  // مابيتخزّنش، فالحساب المتساب على الافتراضي كان بياخد إجابتين
  // مختلفتين من المكانين.
  await R('⭐⭐⭐ ومدير الفرع ممنوع — زي ما الشاشة بتقول بالظبط', 'branchMgr', readStamp, false);
