...
(async () => {
  ...
  // ⚠⚠ الرقم ده **اتغيّر باختيار صريح**، مش عشان تغيير يعدّي:
  // أول زحلقة وقّفت الرمز في النص تمامًا (1.00 فوق و1.00 عند القص)،
  // واتبلّغ بعدها بالنص: "عاوزك من فوق الكيو ار كود ينزل ل تحت حاجه
  // بسيطه". فنزل 0.15مم — والمساحة كلها 2.00مم فاللي بيتدي لفوق
  // بيتاخد من تحت.
  //
  // ⚠⚠ والسقف هنا 0.85 مش أقل: 0.70 هو اللي اتشكى منه في الأول
  // ("بيطلع بره النص بتاعه")، فمانرجعش له.
  check('⭐⭐⭐⭐⭐ الرمز عند خط القص ≥ 0.85مم (كان 0.70 قبل الزحلقة)',
    Q.fromCutMm >= 0.85, { مقفول: Q0.fromCutMm, مفتوح: Q.fromCutMm });
  ...
  check('⭐⭐⭐⭐⭐ وحرف الورقة ≥ 1.1مم (وده اللي النزلة اتعملت عشانه)',
    Q.fromEdgeMm >= 1.1, { مفتوح: Q.fromEdgeMm });
