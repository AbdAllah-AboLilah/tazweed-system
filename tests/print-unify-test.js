...
(async () => {
  ...
  // ============================================================
  // 4) ⭐ "مقسوم ٤" بقى نص هو كمان — مافيش استثناءات خلاص
  // ============================================================
  // ⚠️ كان هنا مكتوب "مقسوم ٤ فاضل صورة — استثناء موثّق". وده كان صح
  // وقتها (مكانش ليه نسخة نصّية)، بس الاستثناء ده هو بالظبط اللي خلّاه
  // **الوحيد اللي بيطلع منغمش** على الورق. اتعمله نسخة نصّية في v0.41.0
  // فبقى زي الكل.
