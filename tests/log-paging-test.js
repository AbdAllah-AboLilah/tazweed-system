...
(async () => {
  ...
  const r = await p.evaluate(async () => {
    ...
    out.setTo400 = setLogPageSize(400);   // السقف الجديد بالظبط
  ...
  // ⚠️ السقف اترفع من 100 لـ400 بطلب: "زود الحد الاقصي بتاع
  // السجل الي ٤٠٠ عرض".
  check('⭐⭐⭐⭐ و400 بتعدّي (السقف الجديد)', r.setTo400 === 400, r.setTo400);
  check('⭐⭐⭐⭐⭐ و500 بتترد لـ400 (مافيش حاجة فوق السقف)',
    r.setTo500 === 400, r.setTo500);
