...
async function tryPrintViaQZ(type, jobs, sizeOptions, onProgress) {
  ...
  try {
    ...
    // ⚠️ الرقم ده اتكبّر من 20 لـ25: كل دفعة رحلة رايح جاي على السوكيت،
    // فكل ما قلّوا كل ما قلّ الوقت الضايع. وفضل صغير كفاية إن الوظيفة
    // الواحدة تبقى خفيفة على الطابعة (ده كان أصل العطل الأول).
    const COPIES_PER_JOB = 25;
