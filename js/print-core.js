...
const PRINT_TWEAKS = [
  ...
  {
    key: 'sheetRaw',
    label: '🧪 ورقة التزويد خام — تتخطّى إعدادات الويندوز (تجريبي)',
    hint:
      'الورقة بتتبعت للطابعة زي إيصال الكاشير بالظبط، من غير ما تعدّي على ' +
      'مقاس الورق المتظبط في تعريف الويندوز. ده بيمنع القص اللي بيحصل لما ' +
      'الورقة تبقى أطول من فورم التعريف على الجهاز. محتاج مفتاح "ورقة ' +
      'ده بيشغّل رسم الورقة كصورة لوحده. لو فشل بيرجع للطريقة العادية ' +
      'لوحده وبيقولك.',
    apply: () => {},
  },
  {
