...
- توليد QR وطباعة اللاصق وورقة التزويد (شكل الورقة والملصق موثّق بالتفصيل في `tarha-inventory-system-spec.md`، أقسام 8 و9، وسيُبنى في هذه المرحلة).
- تثبيت التطبيق فعليًا كأيقونة (الإشعار جاهز، والتثبيت الكامل يحتاج اختبار على الاستضافة الحقيقية).

### تصحيح مهم في هذه النسخة (v0.5.1)

اسم الصنف والباركود كانوا بالغلط مرتبطين بكل درجة لوحدها. **الصح**: هما
خاصية للفئة (التاب) كلها — كل الدرجات جوه نفس الفئة بتشترك في نفس الاسم
ونفس الباركود. اتصلّحت الآن:
- فورم "+ فئة جديدة" بقى بياخد اسم الصنف والباركود مع اسم الفئة.
- فوق جدول كل فئة، هتلاقي شريط بيوري اسم الصنف والباركود الحاليين + زرار "تعديل".
- فورم "+ إضافة درجة" بقى أبسط (رقم الدرجة + الكميات بس، من غير اسم/باركود).

**⚠️ ملاحظة لو كنت ضفت درجات فيها اسم/باركود في النسخة السابقة**: الحقول
القديمة دي هتفضل موجودة في قاعدة البيانات لكن النظام هيتجاهلها، مش هتضرّ
حاجة. الأنضف إنك تمسح أي درجات تجريبية عملتها وتضيفها تاني بالشكل الجديد.
