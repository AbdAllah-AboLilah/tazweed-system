...
- ✅ ~~مؤشر حالة الاتصال المرئي~~ — **تم في هذه النسخة (v0.7.0)**.
...
### جديد في هذه النسخة (v0.7.0) — مؤشر حالة الاتصال

نقطة صغيرة + كلمة توضيحية جنب اسم النظام فوق:
- 🟢 **متصل**: كل حاجة شغالة عادي.
- 🔴 **غير متصل بالإنترنت**: النت مقطوع، لكن النظام لسه بيوريك آخر بيانات
  اتخزنت عندك محليًا (بفضل التخزين IndexedDB المفعّل من الأول).
- 🟡 **جارٍ رفع البيانات...**: النت رجع وفيه تعديلات كانت متراكمة عندك
  محليًا وقت ما كنت أوفلاين، وبيتم رفعها للسحابة تلقائيًا الآن.

مفيش حاجة تحتاج تعملها لتفعيلها — شغالة تلقائيًا فور رفع هذه النسخة.
